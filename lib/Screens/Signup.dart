...
class _SignupState extends State<Signup> {
  ...
  final _confirmPasswordController = TextEditingController(); // Separate controller for confirmation
  ...
  void _register() async {
    if (_passwordController.text != _confirmPasswordController.text) {
     ...
     Center(
      child: Lottie.network('https://lottie.host/85cf1e95-d523-4f86-9c5f-02e8bf6bdccf/vSMazmro0x.json',),
    ...
    try {
      ...
      widget.pageController.animateToPage(1, duration: Duration(seconds: 1), curve: Curves.linear);
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
